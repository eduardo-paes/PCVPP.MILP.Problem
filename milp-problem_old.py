...
RELEASE = [10 for _ in range(NUM_VAGOES)]
#endregion
...
var_y = model.addVar(vtype=gp.GRB.CONTINUOUS, name="y")          ## y[i,j]
...
var_c = model.addVar(vtype=gp.GRB.CONTINUOUS, name="c")          ## C[j]
var_c_max = model.addVar(vtype=gp.GRB.CONTINUOUS, name="c_max")  ## Cmax
#endregion
